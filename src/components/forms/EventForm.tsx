...
// const EventForm: FC<FormComponentProps> = ({ data, onSuccess, onCancel }) => {
//     // Prefill nothing; this form only handles creation for now
...
//         // data.createdBy is injected via FormModal
//         const createdBy = data?.createdBy as string;

//         const payload: Omit<IEvent, "id"> = {
//             title,
...
const EventForm: FC<FormComponentProps> = ({ onSuccess, onCancel }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // Build payload exactly matching createEvent’s type

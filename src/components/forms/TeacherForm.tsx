...
//     birthday: z.string().min(1), // Will parse to Date later
//     sex: z.enum(["male", "female"]),
//     img: z.any(), // Temporarily skip validation for file
// });
...
import { createTeacher } from "@/action/client/user";
...
const TeacherForm = ({ type, data }: { type: "create" | "update"; data?: any }) => {
    ...
    //                 formData.append("img", data.img[0]); // single file
    //             } else {
